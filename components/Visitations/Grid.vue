        ...
        <table class="min-w-full text-left">
          ...
          <tbody>
            <tr v-for="(visit, index) in visitations" :key="index" class="border-b border-gray-50">
              <td class="px-4 py-6 text-[#667185]  text-sm"> {{ `${ visit.tenant.firstName} ${ visit.tenant.lastName}` ?? 'Nil' }}</td>
...
<path d="M15 1.66602V3.33268M5 1.66602V3.33268" stroke="#5B8469" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                  ...
                  <li>
                    ...
                    >
                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M17.4974 10.416C17.4974 10.416 17.4993 10.0249 17.4993 9.58268C17.4993 5.85073 17.4993 3.98476 16.34 2.82538C15.1806 1.66602 13.3146 1.66602 9.58268 1.66602C5.85073 1.66602 3.98476 1.66602 2.82538 2.82538C1.66602 3.98476 1.66602 5.85073 1.66602 9.58268C1.66602 13.3146 1.66602 15.1806 2.82538 16.34C3.98476 17.4993 5.85073 17.4993 9.58268 17.4993C10.0249 17.4993 10.416 17.4974 10.416 17.4974" stroke="#5B8469" stroke-width="1.5" stroke-linecap="round"/>
<path d="M1.66602 5.83398H17.4993" stroke="#5B8469" stroke-width="1.5" stroke-linejoin="round"/>
<path d="M8.33333 13.3333H9.58333M5 13.3333H5.83333M8.33333 10H13.3333M5 10H5.83333" stroke="#5B8469" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
<path d="M13.334 13.334L15.834 15.834M15.834 15.834L18.334 18.334M15.834 15.834L13.334 18.334M15.834 15.834L18.334 13.334" stroke="#5B8469" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
</svg>
