  ...
  <div class="bg-white rounded-lg shadow">
    ...
    <div class="px-6 py-4 border-b border-gray-200">
      <div class="flex items-center justify-between">
        <h1 class="text-2xl font-semibold text-gray-900">Application</h1>
          ...
          <tr v-for="application in applications" :key="application.id" class="hover:bg-gray-50 cursor-pointer" @click="navigateToDetails(application.id)">
            ...
            <td class="px-6 py-4">
              <div class="flex items-center">
                ...
                <span class="text-sm font-medium text-gray-900">{{ application.applicant.name }}</span>
              </div>
            </td>
            <td class="px-6 py-4">
              <span class="text-sm text-gray-900">{{ application.property.name }}</span>
            </td>
            <td class="px-6 py-4">
            ...
            <td class="px-6 py-4">
              <div class="flex items-center">
                ...
                <span class="text-sm text-gray-900">{{ application.location.country }}</span>
              </div>
            </td>
            <td class="px-6 py-4">
