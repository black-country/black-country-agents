<template>
    <div class="flex items-center p-4 border-b-[0.5px] border-gray-100">
      ...
      <div class="ml-auto flex items-center space-x-4">
          ...
          :title="selectedUser?.participant?.phoneNumber ? 'Call ' + selectedUser.participant.phoneNumber : 'No phone number available'"
        >
  ...
  const props = defineProps({
    ...
    const phoneNumber = props.selectedUser?.participant?.phoneNumber;
