                    ...
                    <div class="relative flex justify-between">
                        <div v-for="(step, idx) in steps" :key="idx" class="flex flex-col items-center group">
                            ...
                            <div :class="[
                                ...
                                <svg v-if="currentStep > idx" class="w-6 h-6" fill="none" stroke="currentColor"
                                    viewBox="0 0 24 24">
                    ...
                    <div :key="currentStep" class="absolute inset-0">
                        ...
                        <div v-if="currentStep === 0" class="space-y-8 pb-10">
                            <div class="text-center mb-8">
                                ...
                                <p class="text-slate-600 max-w-2xl text-sm mx-auto">Select the consultation type that
                            ...
                            <div class="grid md:grid-cols-2 gap-6 max-w-4xl mx-auto">
                                ...
                                <button @click="selectType('physical')" :class="[
                                    ...
                                    <div class="absolute inset-0 opacity-10">
                                        <div class="absolute -right-8 -top-8 w-32 h-32 bg-white rounded-full blur-2xl">
                                        </div>
                                        <div
                                            class="absolute -left-8 -bottom-8 w-32 h-32 bg-white rounded-full blur-2xl">
                                        </div>
                                    </div>
                                    ...
                                    <div class="relative">
                                        ...
                                        <!-- Content -->
                                        <h3
                                            :class="['text-xl font-bold mb-2', selectedType === 'physical' ? 'text-white' : 'text-slate-900']">
                                            Physical Visit
                                        </h3>
                                        <p
                                            :class="['text-sm mb-6', selectedType === 'physical' ? 'text-blue-100' : 'text-slate-600']">
                                        ...
                                        <div class="flex items-baseline gap-2">
                                            <span
                                                :class="['text-2xl font-black', selectedType === 'physical' ? 'text-white' : 'text-blue-600']">
                                                ₦{{ settings?.physicalConsultationFee?.toLocaleString() ?? '—' }}
                                            </span>
                                            <span
                                                :class="['text-sm', selectedType === 'physical' ? 'text-blue-100' : 'text-slate-500']">
                                                per session
                                            </span>
                                        </div>
                                        ...
                                        <div class="mt-6 space-y-2">
                                            <div class="flex items-center gap-2 text-sm">
                                                ...
                                                <span
                                                    :class="selectedType === 'physical' ? 'text-blue-100' : 'text-slate-700'">
                                ...
                                <button @click="selectType('virtual')" :class="[
                                    ...
                                    <div class="relative">
                                        ...
                                        <!-- Content -->
                                        <h3
                                            :class="['text-xl font-bold mb-2', selectedType === 'virtual' ? 'text-white' : 'text-slate-900']">
                                            Virtual Call
                                        </h3>
                                        <p
                                            :class="['text-sm mb-6', selectedType === 'virtual' ? 'text-purple-100' : 'text-slate-600']">
                                        ...
                                        <div class="flex items-baseline gap-2">
                                            <span
                                                :class="['text-2xl font-black', selectedType === 'virtual' ? 'text-white' : 'text-purple-600']">
                                                ₦{{ settings?.virtualConsultationFee?.toLocaleString() ?? '—' }}
                                            </span>
                                            <span
                                                :class="['text-sm', selectedType === 'virtual' ? 'text-purple-100' : 'text-slate-500']">
                                                per session
                                            </span>
                                        </div>
                                        ...
                                        <div class="mt-6 space-y-2">
                                            <div class="flex items-center gap-2 text-sm">
                                                ...
                                                <span
                                                    :class="selectedType === 'virtual' ? 'text-purple-100' : 'text-slate-700'">
                                                    Connect from home
                                                </span>
                                            </div>
                                            <div class="flex items-center gap-2 text-sm">
                        ...
                        <div v-if="currentStep === 1" class="space-y-8 pb-10">
                            <div class="bg-white">
                                ...
                                <div v-if="selectedDate">
                                    <label class="block text-sm font-semibold text-slate-700 mb-4">Available Time
                                        Slots</label>
                                    ...
                                    <!-- No Slots -->
                                    <div v-else-if="availableSlotsForSelectedDate.length === 0"
                                    ...
                                    <div v-else class="grid grid-cols-2 sm:grid-cols-3 gap-3">
                                        <button v-for="(slot, idx) in availableSlotsForSelectedDate"
                                            :key="slotKey(slot)" @click="selectedSlot = slot" :class="[
                                            ...
                                            <div class="text-center flex items-center gap-x-2">
                                                <div class="text-sm inline font-bold">{{ formatTime(slot.startTime) }}
                                                </div>
                                                <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28"
                                                    fill="#e8e8e8" viewBox="0 0 256 256">
                                                    <path
                                                ...
                                                <div class="text-xs inline text-slate-500 mt-1">{{
                                                    formatTime(slot.endTime) }}</div>
                                            </div>

                                            <!-- Checkmark -->
                                            <transition name="scale">
                                                <div v-if="selectedSlot && isSameSlot(selectedSlot, slot)"
                                ...
                                <div v-if="selectedType === 'virtual' && selectedSlot"
                                    class="mt-8 pt-8 border-t border-slate-200">
                                    <label class="block text-sm font-semibold text-slate-700 mb-4">Consultation
                                        Mode</label>
                                    <div class="grid grid-cols-2 gap-4">
                                        <button @click="consultationMode = 'video'" :class="[
                                            ...
                                            <div
                                                :class="['w-12 h-12 rounded-xl flex items-center justify-center', consultationMode === 'video' ? 'bg-purple-200' : 'bg-slate-100']">
                                        ...
                                        <button @click="consultationMode = 'voice'" :class="[
                                            ...
                                            <div
                                                :class="['w-12 h-12 rounded-xl flex items-center justify-center', consultationMode === 'voice' ? 'bg-purple-200' : 'bg-slate-100']">
                                                <span class="text-2xl">🎤</span>
                                            </div>
                                ...
                                <div v-if="selectedType === 'physical' && selectedSlot"
                                    class="mt-8 pt-8 border-t border-slate-200">
                                    <div
                        ...
                        <div v-if="currentStep === 2" class="space-y-8 pb-10">
                            <div class="bg-white">
                                <div class="text-center mb-8">
                                    <div
                                        class="w-20 h-20 bg-gradient-to-br from-green-100 to-green-200 rounded-full flex items-center justify-center mx-auto mb-4">
                                ...
                                <div
                                    class="bg-gradient-to-br from-slate-50 to-blue-50 rounded-2xl p-8 border-[0.5px] border-slate-200 mb-8">
                                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                                        <!-- Type -->
                                        <div class="flex items-center gap-4">
                                            <div
                                                class="w-14 h-14 bg-white rounded-xl flex items-center justify-center shadow-sm">
                                                <span class="text-2xl">{{ selectedType === 'physical' ? '🏥' : '💻'
                                                    }}</span>
                                            </div>
                                            <div>
                                        ...
                                        <div v-if="selectedType === 'virtual'" class="flex items-center gap-4">
                                            <div
                                                class="w-14 h-14 bg-white rounded-xl flex items-center justify-center shadow-sm">
                                                <span class="text-2xl">{{ consultationMode === 'video' ? '📹' : '🎤'
                                                    }}</span>
                                            </div>
                                            <div>
                                                <p class="text-xs text-slate-600 font-medium uppercase tracking-wide">
                                        ...
                                        <div class="flex items-center gap-4">
                                            ...
                                            <div>
                                                <p class="text-xs text-slate-600 font-medium uppercase tracking-wide">
                                                    Date</p>
                                                <p class="text-sm font-bold text-slate-900">{{ formatDate(selectedDate)
                                                    }}</p>
                                            </div>
                                        </div>
                                        ...
                                        <div v-if="selectedType === 'physical'"
                                            class="lg:col-span-2 flex items-center gap-4">
                                            <div
                                                class="w-14 h-14 bg-white rounded-xl flex items-center justify-center shadow-sm">
                                                <span class="text-2xl">📍</span>
                                            </div>
                                        ...
                                        <!-- Price -->
                                        <div
                                            class="lg:col-span-2 flex items-center justify-between pt-6 border-t border-slate-200">
                                            <div>
                                            ...
                                            <div class="text-right">
                                                <div
                                                    class="inline-flex items-center gap-2 px-4 py-2 bg-green-100 text-green-700 rounded-full text-sm font-semibold">
                                                    <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                                                        <path fill-rule="evenodd"
                                                            d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z"
                                                            clip-rule="evenodd"></path>
                                ...
                                <div class="bg-blue-50 rounded-2xl p-6 border border-blue-200 mb-8">
                                    ...
                                    <ul class="space-y-2 text-sm text-slate-700">
                                        <li class="flex items-start gap-2">
                                            ...
                                            <span>Payment confirmation will be displayed after successful
                                                transaction</span>
                                        </li>
                            ...
                            <div class="lg:flex gap-4 justify-center px-6 lg:px-0 space-y-3 lg:space-y-0">
                                ...
                                <button @click="handleBooking" :disabled="bookingLoading || initiating"
                                    ...
                                    <svg v-if="bookingLoading || initiating" class="animate-spin h-5 w-5" fill="none"
                                        viewBox="0 0 24 24">
            ...
            <div v-if="showSuccessModal"
                ...
                <div class="bg-white rounded-3xl shadow-2xl max-w-lg w-full p-10 transform scale-100" @click.stop>
                    ...
                    <div class="flex justify-center mb-6">
                        <div class="relative">
                            <div
                                class="w-24 h-24 bg-gradient-to-br from-green-400 to-green-600 rounded-full flex items-center justify-center shadow-lg">
                                <svg class="w-12 h-12 text-white animate-check" fill="none" stroke="currentColor"
                                    viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="3"
                                        d="M5 13l4 4L19 7"></path>
                                </svg>
                    ...
                    <!-- Quick Summary -->
                    <div
                        class="bg-gradient-to-br from-green-50 to-green-100 rounded-2xl p-6 mb-6 border border-green-200">
                        <div class="space-y-3">
                            ...
                            <div class="pt-3 border-t border-green-200 flex justify-between items-center">
                                ...
                                <span class="text-2xl font-bold text-green-600">₦{{ consultationPrice.toLocaleString()
                                    }}</span>
                            </div>
                        </div>
                    </div>

                    <!-- Google Meet Link Section (FIXED) -->
                    <div v-if="paymentCallbackData.meetLink && selectedType === 'virtual'"
                        class="bg-gradient-to-br from-purple-50 to-purple-100 rounded-2xl p-6 mb-6 border border-purple-200">
                        <h4 class="font-bold text-slate-900 mb-3 flex items-center gap-2">
                            <span class="text-2xl">💻</span>
                            Join Your Virtual Consultation
                        </h4>
                        <p class="text-sm text-slate-600 mb-4">Click the link below to join your consultation at the
                            scheduled time:</p>
                        ...
                        <p class="text-xs text-slate-500 text-center mt-3">You can also find this link in your
                            appointments page</p>
                    </div>
            ...
            <div v-if="processingPayment"
                ...
                <div class="bg-white rounded-3xl shadow-2xl max-w-md w-full p-10 text-center">
                    <div class="relative mb-6">
                        <div
                            class="w-20 h-20 border-4 border-blue-100 border-t-blue-600 rounded-full animate-spin mx-auto">
                        </div>
                        <div class="absolute inset-0 flex items-center justify-center">
        ...
        <transition name="modal">
            <div v-if="showErrorModal"
                ...
                <div class="bg-white rounded-3xl shadow-2xl max-w-lg w-full p-10 transform scale-100" @click.stop>
                    ...
                    <div class="flex justify-center mb-6">
                        <div
                            class="w-24 h-24 bg-gradient-to-br from-red-400 to-red-600 rounded-full flex items-center justify-center shadow-lg">
...
const handleBooking = async () => {
    ...
    try {
        ...
        // STEP 1: Create appointment (reserves slot, payment pending)
...
const handlePaymentCallback = async () => {
    ...
    try {
        ...
        if (status === 'success') {
            ...
            // Show success modal with all details including Meet link
...
const closeSuccessModal = () => {
    ...
    // Clear query params and navigate to appointments
...
const retryPayment = () => {
    showErrorModal.value = false
    // Stay on current step to allow user to try payment again
    currentStep.value = 2
}
