      ...
      <table class="w-full text-left">
        <thead class="bg-white">
          <tr>
            ...
            <th scope="col" class="hidden px-3 py-3.5 text-left text-sm font-semibold text-gray-900 sm:table-cell">Time(s)</th>
            <th scope="col" class="hidden px-3 py-3.5 text-left text-sm font-semibold text-gray-900 sm:table-cell">Start Date</th>
            <th scope="col" class="hidden px-3 py-3.5 text-left text-sm font-semibold text-gray-900 sm:table-cell">End Date</th>
            <th scope="col" class="hidden px-3 py-3.5 text-left text-sm font-semibold text-gray-900 md:table-cell">Frequency</th>
        ...
        <tbody>
          <tr v-for="(item, idx) in availability" :key="idx">
            ...
            <td class="hidden px-3 py-4 text-sm text-gray-500 sm:table-cell">
              <p v-for="(itm, index) in item?.times" :key="index">{{ itm }}</p>
            </td>
            ...
            <td class="hidden px-3 py-4 text-sm text-gray-500 md:table-cell">{{ item?.duration }}</td>
